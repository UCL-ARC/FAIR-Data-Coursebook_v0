...
In [Episode 4 (Data Archiving)](05-data-archiving), we will explore that some data repositories such as [DataverseNL](dataverse.nl/) allow you to create a Data Terms of Use statement directly on the platform when you create a data project.   
